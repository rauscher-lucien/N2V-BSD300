...
class Trainer:
    ...
    def __init__(self, data_dict):
        ...
        print("train data:")
        print_jpg_filenames(self.train_data_dir)

        self.val_data_dir = data_dict['val_data_dir']
        print("validation data:")
        print_jpg_filenames(self.val_data_dir)
    ...
    def train(self):
        ...
        train_dataset = DatasetLoadJPG(root_folder_path=self.train_data_dir,
                                    transform=transform_train)
        
        val_dataset = DatasetLoadJPG(root_folder_path=self.val_data_dir,
                                    transform=transform_train)
